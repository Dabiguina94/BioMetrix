# Getting help with `BioMetrix`

Thank you for using `BioMetrix`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/BioMetrix`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/BioMetrix),
...
[search issues and pull requests](https://github.com/Dabiguina94/BioMetrix/issues)
